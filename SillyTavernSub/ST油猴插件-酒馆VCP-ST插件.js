// ==UserScript==
// @name         VCPSub Enhanced UI for SillyTavern
// @namespace    http://tampermonkey.net/
// @version      1.1 // 版本更新，移除了复制按钮
// @description  Adds a floating clock, VCP admin button, and prettifies VCP-ToolUse blocks (hides copy button in VCP blocks) in SillyTavern.
// @author       Xiaoke & Ryan
...
(function() {
    ...
    console.log('VCPSub Enhanced UI: Script started.');

    // --- Section 1: Floating Clock and VCP Admin Button ---

    function createFloatingClockAndButton() {
        console.log('VCPSub Enhanced UI: Creating floating clock and button.');
        document.title = '莱恩VCP';

        const clockContainer = document.createElement('div');
        clockContainer.id = 'xiaoke-floating-container';
        const timeElement = document.createElement('div');
        timeElement.id = 'xiaoke-clock-time';
        const dateElement = document.createElement('div');
        dateElement.id = 'xiaoke-clock-date';
        const adminButton = document.createElement('button');
        adminButton.id = 'xiaoke-vcp-admin-button';
        ...
        console.log('VCPSub Enhanced UI: Floating clock and button added.');
    }

    // --- Section 2: VCP ToolUse Prettifier ---
    ...
    function initializeScript() {
        ...
        console.log('VCPSub Enhanced UI: All components initialized.');
    }
