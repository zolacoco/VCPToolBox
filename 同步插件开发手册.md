...
*   **示例**:
    ...
    VOLCENGINE_API_KEY=sk-UJPctS27q9WorJqKhdDIlu9iil54LA8U3orLXiM7bwFQeZx1
    ```
...
*   **示例**: 假设AI需要先列出 `/home/user/docs` 目录的内容，然后读取该目录下的 `report.txt` 文件。AI应该构造如下的 `tool_name:「始」FileOperator「末」` 的参数：
